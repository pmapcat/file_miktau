...
func generateStressDataSet(input []*AppStateItem, amount int) []*AppStateItem {
	tags := []string{}
	file_names := []string{}
	...
	for i := 0; i <= amount; i++ {
		result = append(result,
			newAppStateItemFromDemoDataSet(strconv.Itoa(rand.Intn(1000)), tagsLorem(10), tagsLorem(10), fnamesLorem(10), randomTime()))
	}
	return result
}

func buildDachaDataset() []*AppStateItem {
	points := [][]string{
	...
	for _, v := range points {
		...
		result = append(result, newAppStateItemFromDemoDataSet(fsize, "/home/mik/dacha/", tags, filename, t))
	}
	return result
}

func buildDemoDataset() []*AppStateItem {
	points := [][]string{
	...
	for _, v := range points {
		...
		result = append(result, newAppStateItemFromDemoDataSet(fsize, fpath, tags, filename, t))
	}
	return result
}
